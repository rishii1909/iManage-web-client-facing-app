...
const device_add = () => {
  ...
  useEffect(() => {
    const type = device_types.includes(router.query.type)
      ? router.query.type
      : false;
    ...
    <Device_dashboard subdomain="Add Device">
      ...
      >
        <Form.Item
          ...
          label="Type"
          rules={[
            { required: true, message: "Please select a remote device type" },
          ]}
        >
          <Select
        ...
        <Form.Item
          ...
          label="Name"
          rules={[
            { required: true, message: "Please enter a name for this device." },
          ]}
        >
        ...
        <Form.Item
          ...
          rules={[
            { required: true, message: "Please enter your device's hostname." },
          ]}
        >
          <Input placeholder="Enter hostname"></Input>
        </Form.Item>
        {server_type != "1" && form.getFieldValue("type") !== "2" && (
          <>
            <Form.Item
              name="username"
              label="Username"
