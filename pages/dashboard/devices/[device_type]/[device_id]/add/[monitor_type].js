...
const create_monitor_view = () => {
  ...
  if (typeof window !== "undefined") {
    if (valid_monitors.includes(monitor_type)) {
      var MonitorSettingsPanel = dynamic(() =>
        import(`../../../../../../components/monitors/settings/${monitor_type}`)
      );
    } else {
  ...
  const on_finish = async (data) => {
    ...
    if (Array.isArray(data.offline_time_1)) {
      data.offline_times.offline_time_1_start = `${data.offline_time_1[0][
        "_d"
      ].getMinutes()} ${data.offline_time_1[0]["_d"].getHours()} * * *`;
      data.offline_times.offline_time_1_stop = `${data.offline_time_1[1][
        "_d"
      ].getMinutes()} ${data.offline_time_1[1]["_d"].getHours()} * * *`;
    }
    if (Array.isArray(data.offline_time_2)) {
      data.offline_times.offline_time_2_start = `${data.offline_time_2[0][
        "_d"
      ].getMinutes()} ${data.offline_time_2[0]["_d"].getHours()} * * *`;
      data.offline_times.offline_time_2_stop = `${data.offline_time_2[1][
        "_d"
      ].getMinutes()} ${data.offline_time_2[1]["_d"].getHours()} * * *`;
    }
