...
export default function login_form() {
  ...
  const onFinish = (values) => {
    axios
      .post(`${process.env.API_URL}/login`, values)
      .then((r) => {
  ...
  const send_otp = () => {
    ...
    axios
      .post(`${process.env.API_URL}/forgot_password/send_otp`, {
        email: otp_email,
      })
      .then((r) => {
        const response = r.data;
  ...
  const verify_otp = () => {
    axios
      .post(`${process.env.API_URL}/forgot_password/verify_otp`, {
        otp: otp_verify,
      })
      .then((r) => {
        const response = r.data;
            ...
            {!forgotPassword ? (
              <>
                ...
                <Form.Item>
                  ...
                  <br></br>
                  <br></br>
                  <div style={{ textAlign: "right", margin: "auto 0px" }}>
              ...
              <>
                ...
                <p>
                  Please enter your email address, an OTP will be sent to help
                  reset your password.
                </p>
                <Form.Item name="otp_email">
                  <Input
