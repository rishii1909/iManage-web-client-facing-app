...
const CpuMonitorAggregates = ({monitor, device_id, agent_id}) => {
    ...
    function fetchHourlyMonitors(device, agent_id, before, after){
        ...
        if(device && agent_id && monitor){
            ...
            secure_axios(
                ...
                {
                    ...{
                        api_path : '/api/cpu_monitor/fetch/trends/hourly',
                        api_method : 'post',
    ...
    function fetchDailyMonitors(device, agent_id, before, after){
        ...
        if(device && agent_id && monitor){
            ...
            secure_axios(
                ...
                {
                    ...{
                        api_path : '/api/cpu_monitor/fetch/trends/daily',
                        api_method : 'post',
                        monitor_ref : monitor.agent_id,
                        agent_id : agent_id,
                        ...(before) && {before : before},
...
export default CpuMonitorAggregates;