...
import {PageHeader, Carousel, Checkbox, DatePicker, Select, Button, Switch} from "antd";
...
const DiskMonitorAggregates = ({monitor, device_id, agent_id}) => {
    ...
    function fetchHourlyMonitors(device, agent_id, before, after){
        ...
        if(device && agent_id && monitor){
            ...
            secure_axios(
                ...
                {
                    ...{
                        api_path : '/api/disk_monitor/fetch/trends/hourly',
                        api_method : 'post',
    ...
    function fetchDailyMonitors(device, agent_id, before, after){
        ...
        if(device && agent_id && monitor){
            ...
            secure_axios(
                ...
                {
                    ...{
                        api_path : '/api/disk_monitor/fetch/trends/daily',
                        api_method : 'post',
                        monitor_ref : monitor.agent_id,
                        agent_id : agent_id,
                        ...(before) && {before : before},
    ...
    return (
            <div>
                ...
                <Carousel ref={ref => slider.current = ref} prevArrow={<Button primary icon={<ArrowRightOutlined />} >Next slide</Button>} nextArrow={<Button primary icon={<ArrowLeftOutlined />} >Next slide</Button>} autoplay={autoPlay} dots={true} arrows dotPosition="top" >
                    ...
                    <Button onClick={() => slider.current.goTo(3)}>Click me</Button>
                        ...
                        {!hourlyLoading && 
                            ...
                            <div style={{marginBottom : '2em'}}>
                            <h2>Used space trends</h2>
                            <Line
                            {...chartConfig}
                            data={hourly}
                            yField="used_space_avg"
                            annotations={false}
                            />
                            </div>
                            </>
...
export default DiskMonitorAggregates;